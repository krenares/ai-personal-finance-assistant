...
export const WalletIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 0 0-2.25-2.25H15a3 3 0 1 1-6 0H5.25A2.25 2.25 0 0 0 3 12m18 0v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6m18 0-2.25-4.5M3 12l2.25-4.5M12 12.75v-1.5m0 1.5a2.25 2.25 0 0 1-2.25 2.25H9.75a2.25 2.25 0 0 1-2.25-2.25M12 12.75v-1.5m0 1.5a2.25 2.25 0 0 0 2.25 2.25h.51a2.25 2.25 0 0 0 2.25-2.25M12 12.75v-1.5" />
  </svg>
);
...
export const DebtIcon: React.FC = () => (
...
export const SendIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className || "w-5 h-5"}>
        <path d="M3.105 2.289a.75.75 0 00-.826.95l1.414 4.949a.75.75 0 00.95.534h6.105a.75.75 0 000-1.5H4.994l-1.1-3.85A.75.75 0 003.105 2.29zM15.25 15.25a.75.75 0 001.5 0v-6.5a.75.75 0 00-1.5 0v6.5zM12.03 17.03a.75.75 0 001.06 0l3-3a.75.75 0 00-1.06-1.06L12 15.94l-2.97-2.97a.75.75 0 00-1.06 1.06l3 3z" transform="rotate(90 10 10)" />
    </svg>
);
